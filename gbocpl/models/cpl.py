...
class CPL(nn.Module):
    ...
    def forward(self, frames_feat, frames_len, words_id, words_feat, words_len, weights, **kwargs):
        ...
        gen = {
            'gauss':     self.generate_gauss_weight,
        ...
        try:
            gauss_weight = gen[self.mask_type](props_len, gauss_center, gauss_width)
        except KeyError:
    ...
    def generate_rq_mask(self, props_len, center, width, num_mask=1):
        ...
        r = 8.0 * (2.0 * alpha * (2.0**(1.0/alpha) - 1.0))**0.5
